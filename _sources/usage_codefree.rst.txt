...
As shown above simple permanent changes can be made to the conf file. The reduces commandline inputs. 

The conf file may be provided as a commandline argument. 
